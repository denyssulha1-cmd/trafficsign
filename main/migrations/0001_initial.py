# Generated by Django 3.2.8 on 2025-10-16 17:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Адміністратор'), ('user', 'Користувач')], default='user', max_length=10, verbose_name='Роль користувача')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', models.ImageField(blank=True, null=True, upload_to='signs_photos/', verbose_name='Фото знака')),
                ('name_sign', models.CharField(max_length=150, verbose_name='Назва знака')),
                ('accuracy', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Точність (%)')),
